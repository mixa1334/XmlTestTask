...
<Objects>
    ...
    <Object ID="10" Name="NESTED_FN_CALL_PROBLEM" Schema="" Type="Function" java_package="">
        ...
        <Function DML="NO" ID="2" IsDb="false" Name="nested_fn_call_problem" Out="No" target_type="BigDecimal" type="NUMBER">
            ...
            <Param ID="3" In="1" Name="p_LOGIN_ID1" pos="1" target_type="String" type="VARCHAR2"/>
            			
            <Param ID="4" In="1" Name="p_UPDATE_DATE2" pos="2" target_type="BigDecimal" type="NUMBER"/>
            		
        </Function>
        		
        <Function DML="NO" ID="5" IsDb="false" Name="InsertDtl" Out="No" target_type="BigDecimal" type="NUMBER">
            			
            <Param ID="6" In="1" Name="p_LOGIN_ID1" pos="1" target_type="" type="VARCHAR2"/>
            ...
            <Param ID="7" In="1" Name="p_UPDATE_DATE4" pos="4" target_type="String" type="VARCHAR2"/>
    ...
    <Object ID="22" Name="NESTED_FN_IN_PKG" Schema="" Type="Package">
        ...
        <Function DML="NO" ID="23" IsDb="false" Name="nested_multiply_5" Out="No" isPrivate="No" java_package="" target_type="" type="INTEGER">
            ...
            <Param ID="45" In="1" Name="p_UPDATE_DATE5" pos="5" target_type="Timestamp" type="DATETIME"/>
    ...
    <Object ID="37" Name="NESTED_FN_USING_RECORD" Schema="" Type="Package">
        ...
        <Procedure ID="38" IsDb="true" Name="sp_outer" Out="No" isPrivate="No" java_package="">
            ...
            <Param ID="46" In="1" Name="p_UPDATE_DATE3" pos="3" target_type="Integer" type="INT"/>
